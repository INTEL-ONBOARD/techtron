  ...
  return (
    <section className="text-gray-600 body-font">
      ...
      <div className="flex flex-row gap-4">
        {/* inventory table section(left) */}
        <div className="pl-3 pr-3 w-2/3">
          ...
          {/* new item button */}
          <button className="mt-5 py-2.5 px-3.5 text-sm font-semibold text-white bg-[#1A318C] rounded-lg shadow-sm transition duration-200 hover:bg-blue-700 focus:bg-blue-900 focus:shadow-sm focus:ring-4 focus:ring-blue-900 focus:ring-opacity-50">
            New Item
          </button>
